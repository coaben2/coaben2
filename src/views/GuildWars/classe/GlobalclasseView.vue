...
const professions = ref([
  {
    ...
    mechanics: [
      ...
      '<strong>Parangon :</strong> Meneur de troupes maniant la lance et des chants pour inspirer ses alliés.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Luminescence :</strong> Focalise l\'énergie solaire des Vertus pour renforcer ses frappes et son soutien.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Conduit :</strong> Canalise les énergies des Brumes pour devenir un vecteur éthéré offensif.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Ventireur :</strong> Manie la lance et les courants ascendants pour frapper avec la force d\'un ouragan.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Antiquaire :</strong> Exploite des artefacts des Brumes et la lance pour surprendre ses proies.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Amalgame :</strong> Fusionne technologie et énergie brute via une lance conductrice pour surcharger la réalité.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Évocateur :</strong> Utilise méditations et familiers élémentaires pour dominer le champ de bataille.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Troubadour :</strong> Transforme sa lance en diapason éthéré pour amplifier la douleur ennemie.',
    ],
  ...
  },
  {
    ...
    mechanics: [
      ...
      '<strong>Ritualiste :</strong> Communique avec les défunts via la lance pour invoquer urnes et cendres sacrées.',
    ],
