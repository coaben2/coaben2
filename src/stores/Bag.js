...
const organize = () => {
  ...
  $('#items').show();
  $('#crafts tbody').empty();
  $('#crafts tbody').html('<tr><td class="cost">en construction...</td></tr>');
  $('#crafts').show();
  $('#tips tbody').empty();
  $('#tips tbody').html('<tr><td class="cost">en construction...</td></tr>');
  $('#tips').show();
  $('#raresalvage tbody').empty();
  $('#raresalvage tbody').html('<tr><td class="cost">en construction...</td></tr>');
  $('#raresalvage').show();

};
const getBankListings = (apiKey) => {
...
const addItem = (item, source) => {
  if (item) {
    ...
    if (item.count % 250 > 0 && item.count > 0) {
      ...
      let itemSources = partialStacks[item.id] || [];
    ...
    itemSource.count = item.count;
    itemSource.source = source;
    let itemSources = itemPlacements[item.id] || [];
    itemSources.push(itemSource);
    itemPlacements[item.id] = itemSources;
  }
}
const addItemSource = (itemSource, t) => {
...
const processItems = () => {
  ...
  if (itemCounts[36041] >= 1000 && itemCounts[36041] > collections) {
    ...
    t.push('Exchange candy corn for ' + Math.floor(itemCounts[36041] / 1000) + 'x <a href="https://wiki-fr.guildwars2.com/wiki/Agglom%C3%A9rat_de_bonbons">Agglomérat de bonbons</a>.');
    t.push('</td>');
  ...
  if (itemCounts[46731] > collections) {
    ...
    if (itemCounts[66999] > 0) {
      t.push('Feed your <a href="https://wiki-fr.guildwars2.com/wiki/Mawdrey_II">Mawdrey II</a> pour se débarrasser ' + itemCounts[46731] + ' excès de poussière de pierre de sang. Cela prendra ' + Math.ceil(0.9 * (itemCounts[46731] / 250)) + ' days.');
    } else {
      t.push('Obtain <a href="https://wiki-fr.guildwars2.com/wiki/Mawdrey_II">Mawdrey II</a>.');
    }
    t.push('</td>');
  ...
  if (itemCounts[46735] > collections) {
    ...
    if (itemCounts[68369] > 0) {
      t.push('Use your <a href="https://wiki-fr.guildwars2.com/wiki/%C3%89toile_de_la_gratitude">Étoile de la gratitude</a> pour se débarrasser ' + itemCounts[46735] + ' excès de Fragment empyréen. Cela prendra ' + Math.ceil(0.9 * (itemCounts[46735] / 250)) + ' days.');
    } else {
      t.push('Obtain <a href="https://wiki-fr.guildwars2.com/wiki/%C3%89toile_de_la_gratitude">Étoile de la gratitude</a>.');
    }
    t.push('</td>');
  ...
  if (itemCounts[46733] > collections) {
    ...
    if (itemCounts[69887] > 0) {
      t.push('Feed your <a href="https://wiki-fr.guildwars2.com/wiki/Princesse">Princess</a> pour se débarrasser ' + itemCounts[46733] + ' excès de dragonite. Cela prendra' + Math.ceil(0.9 * (itemCounts[46733] / 250)) + ' days.');
    } else {
      t.push('Obtain <a href="hhttps://wiki-fr.guildwars2.com/wiki/Princesse">Princess</a>.');
    }
    t.push("</td>");
  ...
  if (itemCounts[43773] > collections) {
    ...
    t.push('Convert your <a href="https://wiki-fr.guildwars2.com/wiki/Cristal_de_quartz">Crystals de quartz</a> to <a href="https://wiki-fr.guildwars2.com/wiki/Cristal_de_quartz_charg%C3%A9">Crystal de quartz chargé</a>.');
    t.push("</td>");
  ...
  if (!canner) {
    ...
    t.push('Complete <a href="https://wiki-fr.guildwars2.com/wiki/C%27est_dans_la_bo%C3%AEte">Bocal bizarre</a> pour obtenir un sac de 20 emplacements.');
    t.push("</td>");
  ...
  if (!bandit) {
    ...
    t.push('" /><td class="name" rowspan="1">');
    t.push('Complete <a href="http://wiki.guildwars2.com/wiki/Bandit_Weapons_Specialist">Bandit Weapons Specialist</a> pour obtenir un sac de 20 emplacements.');
    t.push("</td>");
    t.push('<td class="cost">&nbsp;</td></tr>');
  }
  ...
  if (itemCounts[45175] > 250 || (itemCounts[45175] > 0 && itemCounts[45175] % 5 == 0)) {
    ...
    t.push('Mettez à niveau votre ' + itemCounts[45175] + ' essences de chance avec artificier et/ou les consommer.');
    t.push("</td>");
  ...
  if (itemCounts[45176] > 250 || (itemCounts[45176] > 0 && itemCounts[45176] % 2 == 0)) {
    ...
    t.push('Mettez à niveau votre ' + itemCounts[45176] + ' essences de chance avec artificier et/ou les consommer.');
    t.push("</td>");
  ...
  if (itemCounts[45177] > 250 || (itemCounts[45177] > 0 && itemCounts[45177] % 2 == 0)) {
    ...
    t.push('Mettez à niveau votre ' + itemCounts[45177] + ' essences de chance avec artificier et/ou les consommer.');
    t.push("</td>");
  ...
  if (itemCounts[45178] > 0) {
    ...
    t.push('consomer ' + itemCounts[45178] + ' essences de chance');
    t.push("</td>");
...
const fetchItemPricesRarePrices = (items) => {
  if (items.length > 0) {
